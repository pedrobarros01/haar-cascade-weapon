...
opencv_createsamples -info amostras.lst -num 2775 -w 24 -h 24 -vec positives.vec
opencv_traincascade -data classifier -vec positives.vec -bg bg.txt -numPos 2775 -numNeg 4488 -numStages 25 -w 24 -h 24
